            ...
            <div className="space-y-4 p-6 text-sm leading-relaxed text-white/85 md:p-8">
              ...
              {activeModal === "datenschutz" && (
                <div className="space-y-4">
                  ...
                  <p>AutoWunsch.com wird über die DigitalOcean App Platform in der EU-Region Frankfurt bereitgestellt. DigitalOcean verarbeitet technische Zugriffsdaten und Serverlogs wie IP-Adresse, Zeitpunkt, URL, Statuscode und Browserdaten zur Auslieferung, Sicherheit und Fehleranalyse. Zur zuverlässigen Verarbeitung bestätigter Zahlungen speichern wir zusätzlich minimal die Stripe-Event-ID, die Checkout-Session-ID, Zeitstempel und Bearbeitungsstatus in einer privaten, von DigitalOcean betriebenen PostgreSQL-Datenbank; vollständige Bestell- oder Mailinhalte werden dort nicht abgelegt. Zahlungen laufen über Stripe; Stripe verarbeitet Zahlungs- und Checkout-Daten eigenverantwortlich bzw. als Dienstleister. E-Mails werden über einen SMTP-Dienst versendet; dafür werden Empfängeradresse, Inhalt und Versandmetadaten verarbeitet.</p>
